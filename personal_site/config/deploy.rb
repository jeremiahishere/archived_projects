...
set :application, "jeremiahhemphill"

set :repository,  "git@github.com:jeremiahishere/personal_site.git" # repo clone url
set :scm, :git # use git
set :branch, "master"
...
role :web, "jeremiahhemphill.com"
role :app, "jeremiahhemphill.com"
role :db,  "jeremiahhemphill.com", :primary => true
